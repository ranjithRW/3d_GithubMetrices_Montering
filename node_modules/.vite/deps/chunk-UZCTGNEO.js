...
project.ready.then(() => {
  sequence.play()
    ...
    function rgba2hex(rgba2) {
      const hex = (rgba2.r * 255 | 1 << 8).toString(16).slice(1) + (rgba2.g * 255 | 1 << 8).toString(16).slice(1) + (rgba2.b * 255 | 1 << 8).toString(16).slice(1) + (rgba2.a * 255 | 1 << 8).toString(16).slice(1);
      return `#${hex}`;
    }
 ...
 */
//# sourceMappingURL=chunk-UZCTGNEO.js.map
