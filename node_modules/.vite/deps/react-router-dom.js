...
function createRouter(init) {
  ...
  async function startNavigation(historyAction, location, opts) {
    ...
    if (opts && opts.pendingError) {
      ...
      let actionResult = await handleAction(request, location, opts.submission, matches, scopedContext, fogOfWar.active, opts && opts.initialHydration === true, { replace: opts.replace, flushSync: flushSync2 });
      ...
      try {
        ...
        let response = await runMiddlewarePipeline({
          ...
          if (renderedStaticContext) {
            ...
            let boundaryRouteId = skipLoaderErrorBubbling ? routeId : findNearestBoundary(matches, ((_a = matches.find((m) => m.route.id === routeId || m.route.loader)) == null ? void 0 : _a.route.id) || routeId).route.id;
            return respond({
              matches,
              location,
              basename,
...
async function callDataStrategyImpl(dataStrategyImpl, request, matches, fetcherKey, scopedContext, isStaticHandler) {
  ...
  let unstable_runClientMiddleware = isStaticHandler ? () => {
    ...
    return runMiddlewarePipeline(typedDataStrategyArgs, false, () => cb(__spreadProps(__spreadValues({}, typedDataStrategyArgs), {
      fetcherKey,
  ...
  let results = await dataStrategyImpl(__spreadProps(__spreadValues({}, dataStrategyArgs), {
    fetcherKey,
    unstable_runClientMiddleware
  }));
  try {
        ...
        while (Object.keys(encoder2.deferred).length > 0) {
          for (const [deferredId, deferred] of Object.entries(encoder2.deferred)) {
            if (seenPromises.has(deferred))
              continue;
            seenPromises.add(encoder2.deferred[Number(deferredId)] = Promise.race([
              racePromise,
              deferred
            ]).then((resolved) => {
...
function RemixRootDefaultHydrateFallback() {
  return React6.createElement(BoundaryShell, { title: "Loading...", renderScripts: true }, ENABLE_DEV_WARNINGS ? React6.createElement("script", {
    dangerouslySetInnerHTML: {
      __html: `
              console.log(
...
function useFogOFWarDiscovery(router2, manifest, routeModules, ssr, routeDiscovery, isSpaMode) {
  React8.useEffect(() => {
    ...
    async function fetchPatches() {
      ...
      try {
        await fetchAndApplyManifestPatches(lazyPaths, null, manifest, routeModules, ssr, isSpaMode, router2.basename, routeDiscovery.manifestPath, router2.patchRoutes);
      } catch (e) {
...
import(${JSON.stringify(manifest.entry.module)});`;
  ...
  return isHydrated ? null : React9.createElement(React9.Fragment, null, typeof manifest.sri === "object" ? React9.createElement("script", {
    "rr-importmap": "",
    type: "importmap",
    suppressHydrationWarning: true,
    dangerouslySetInnerHTML: {
  ...
  }) : null, !enableFogOfWar ? React9.createElement("link", {
    rel: "modulepreload",
    href: manifest.url,
    ...
    suppressHydrationWarning: true
  }), preloads.map((path) => React9.createElement("link", {
    key: path,
    rel: "modulepreload",
    href: path,
    crossOrigin: props.crossOrigin,
...
function createHydratedRouter({
  ...
  if (ssrInfo.context.isSpaMode) {
    ...
    }, window.location, (_b = window.__reactRouterContext) == null ? void 0 : _b.basename, ssrInfo.context.isSpaMode);
