...
declare type Loggable = Record<string, any>;
declare type ITheatreLoggerConfig = /** default {@link console} */ 'console' | {
    type: 'console';
    /** default `true` */
    style?: boolean;
...
declare type ITheatreLogSource = {
    names: {
        name: string;
        key?: number | string;
    }[];
};
declare type ITheatreLogIncludes = {
    /**
...
declare type ITheatreLoggingConfig = ITheatreLogIncludes & {
    include?: (source: ITheatreLogSource) => ITheatreLogIncludes;
    consoleStyle?: boolean;
};
declare enum TheatreLoggerLevel {
    TRACE = 64,
    DEBUG = 128,
    WARN = 256,
    ERROR = 512
...
declare type IProjectConfigExperiments = {
    /**
